...
if dimensions_file == "no":
    ...
    print(
        "\n\r" + color.GREEN + "Place a text file in the same folder as the script and call it" +
        color.END + color.BOLD + " lev.txt " + color.END + color.GREEN + "with the following format:" + color.END +
        "\n\r" + "vikt <siffra i kg>" + "\n\r" + "langd <siffra i cm>" + "\n\r" + "bredd <siffra i cm>" + "\n\r" +
        "hojd <siffra i cm>")
    print(
...
if confirm == "yes":
    ...
    print(
        "Navigate to https://api2.fraktjakt.se/carts?locale=sv in your browser to accept the payment "
        "and print labels" + '\n'
    )
else:
    exit()
